...
const Hero = () => {
	return (
		<div className="relative isolate min-h-screen overflow-hidden pt-14">
			...
			<div className="mx-auto max-w-2xl pb-32 sm:py-48 lg:pt-24 lg:pb-56">
				<Image
				...
				<div className="text-center">
					...
					<p className="mt-6 text-lg leading-8 text-gray-300">
						A community-based boxing club founded on the principles of respect,
						responsibility, hard work and integrity.
					</p>
