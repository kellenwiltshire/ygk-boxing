...
const Rules = () => {
	return (
		<div className="mx-8 max-w-7xl py-20 md:mx-10">
			...
			<p className="py-4 font-bold">
				Boxing is an art of self defence and is not to be used to street fight
				and intimidate. If any member of YGK Boxing is found using boxing skills
				to street fight or intimidate they will not be permitted to use the club
				and any boxing license will be withdrawn. No exceptions.
			</p>
		</div>
	)
}
