...
const Calendar = () => {
	...
	return (
		<div className="hidden max-w-7xl pb-8 md:block lg:flex lg:h-full lg:flex-col lg:pb-0">
			...
			<div className="ring-opacity-5 shadow ring-1 ring-black lg:flex lg:flex-auto lg:flex-col">
				<div className="grid grid-cols-7 gap-px border-b border-gray-300 bg-gray-200 text-center text-xs leading-6 font-semibold text-gray-700 lg:flex-none">
				...
				<div className="flex bg-gray-200 text-xs leading-6 text-gray-700 lg:flex-auto">
					<div className="hidden w-full sm:grid sm:grid-cols-7 sm:grid-rows-1 sm:gap-px">
						{events.map((day: IDay, index: number) => (
							...
							>
								{day.events.length > 0 && (
									<ol className="divide-y-gray-500 mt-2 divide-y-2">
										{day.events.map((event) => (
											...
											>
												<div className="group flex flex-col">
													<time
														dateTime={event.time}
														className="block flex-none text-gray-500"
													>
														{event.time}
													</time>
